...
std::array<GLuint, 4>   tSeverBody    {};
std::array<GLuint, 4>   tSeverArm     {};
std::array<GLuint, 4>   tSeverLegs    {};
...
// (InsideCell and CellVisible defined in world_props.cpp)
...
// (GenerateCharacter defined in data.cpp)
